...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection article_title
     * @property Grid\Column|Collection article_tag
     * @property Grid\Column|Collection article_content
     * @property Grid\Column|Collection article_describe
     * @property Grid\Column|Collection article_click
     ...
     * @method Grid\Column|Collection article_title(string $label = null)
     * @method Grid\Column|Collection article_tag(string $label = null)
     * @method Grid\Column|Collection article_content(string $label = null)
     * @method Grid\Column|Collection article_describe(string $label = null)
     * @method Grid\Column|Collection article_click(string $label = null)
     ...
     * @property Show\Field|Collection article_title
     * @property Show\Field|Collection article_tag
     * @property Show\Field|Collection article_content
     * @property Show\Field|Collection article_describe
     * @property Show\Field|Collection article_click
     ...
     * @method Show\Field|Collection article_title(string $label = null)
     * @method Show\Field|Collection article_tag(string $label = null)
     * @method Show\Field|Collection article_content(string $label = null)
     * @method Show\Field|Collection article_describe(string $label = null)
     * @method Show\Field|Collection article_click(string $label = null)
